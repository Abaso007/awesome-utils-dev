...
-   [TOOLS: CHATGPT](#tools-chatgpt)

-   [TOOLS: TEXT / DOCS / PDF](#tools-text--docs--pdf)
...
-   [LIB: REAL TIME](#lib-real-time)

-   [LIB: RECOMMENDATION](#lib-recommendation)
...
-   [LIB: WORKFLOW / CONTENT CREATION : N8N](#lib-workflow--content-creation--n8n)

-   [LIB: NEURAL NETWORK](#lib-neural-network)

-   [LIB: FULL FRAMEWORK](#lib-full-framework)
...
-   [LIB: LABELLING](#lib-labelling)

-   [LIB: VIZ](#lib-viz)

-   [LIB: PREDICTION](#lib-prediction)

-   [LIB: TENSORFLOW](#lib-tensorflow)

-   [LIB: BOT / CUSTOMER SUPPORT](#lib-bot--customer-support)
