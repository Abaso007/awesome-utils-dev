...
-   [INSTALL](#install)
-   [COMPOSER](#composer)
-   [XAMPP VIRTUAL HOST](#xampp-virtual-host)
-   [XAMPP INCLUDE HTML PAGES](#xampp-include-html-pages)
-   [HOST](#host)
-   [SECURITY](#security)
-   [LISTS](#lists)
-   [LIBS: ALL](#libs-all)
...
-   [DEVTOOLS](#devtools)
-   [LIB:](#lib)
-   [SLIM PHP UTILS](#slim-php-utils)
-   [SLIM PHP V3 SKELETON](#slim-php-v3-skeleton)
-   [SLIM PHP V4 SKELETON](#slim-php-v4-skeleton)
-   [SLIM PHP AUTH JWT](#slim-php-auth-jwt)
-   [PSR15](#psr15)
-   [SLIM PHP TEST](#slim-php-test)
-   [CMS / HEADLESS](#cms--headless)
-   [ASYNCRONOUS ASYNCRONOUS](#asyncronous-asyncronous)
-   [AUTODEPLOY](#autodeploy)
-   [IDE + EXTENSION](#ide--extension)
-   [CQRS / DDD / EventSourcing](#cqrs--ddd--eventsourcing)
-   [XAMPP](#xampp)
-   [ENV CONF](#env-conf)
-   [SSO](#sso)
...
-   [TESTS](#tests)
-   [ORM](#orm)
-   [PDO WRAPPER (ORM ALTERNATIVE)](#pdo-wrapper-orm-alternative)
-   [PDF LIB](#pdf-lib)
-   [PROXY](#proxy)
-   [STATIC ANALYZER / ANALYZYS](#static-analyzer--analyzys)
-   [PHP VSCODE EXTENSIONS](#php-vscode-extensions)
