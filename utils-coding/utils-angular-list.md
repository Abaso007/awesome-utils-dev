...
-   [HELPER: DECISIONS SYNC](#helper-decisions-sync)
...
-   [CORE: TEMPLATE / PROJECTION](#core-template--projection)
...
-   [CORE: STANDALONE](#core-standalone)

-   [CORE: MODULES](#core-modules)

-   [CORE: FORMS](#core-forms)

-   [CORE: FORMS: TEMPLATE](#core-forms-template)
...
-   [CORE: MIGRATION ANGULARJS](#core-migration-angularjs)

-   [ECOSYSTEM: COMPANIES](#ecosystem-companies)

-   [ECOSYSTEM: AUTHENTIFICATION](#ecosystem-authentification)

-   [ECOSYSTEM: STORE: NGRX](#ecosystem-store-ngrx)

-   [ECOSYSTEM: STORE: NGRX: DEMO](#ecosystem-store-ngrx-demo)

-   [ECOSYSTEM: STORE: NGRX: ARTICLES](#ecosystem-store-ngrx-articles)
...
-   [ECOSYSTEM: STORE: SIGNAL STORE](#ecosystem-store-signal-store)

-   [ECOSYSTEM: STORE: ALTERNATIVE](#ecosystem-store-alternative)

-   [ECOSYSTEM: WEB-COMPONENTS WEBCOMPONENTS](#ecosystem-web-components-webcomponents)
...
-   [ECOSYSTEM: LIB: MONOREPO](#ecosystem-lib-monorepo)

-   [ECOSYSTEM: LIB: MONOREPO: NX LANGAGES PLUGINS](#ecosystem-lib-monorepo-nx-langages-plugins)

-   [ECOSYSTEM: LIB: MONOREPO: NX FRAMEWORKS PLUGINS](#ecosystem-lib-monorepo-nx-frameworks-plugins)

-   [ECOSYSTEM: LIB: MONOREPO: NX CI/CD PLUGINS](#ecosystem-lib-monorepo-nx-cicd-plugins)

-   [ECOSYSTEM: LIB: MONOREPO: NX TOOLS](#ecosystem-lib-monorepo-nx-tools)

-   [ECOSYSTEM: LIB: MONOREPO: NX CACHE (TOADD)](#ecosystem-lib-monorepo-nx-cache-toadd)

-   [ECOSYSTEM: LIB: MONOREPO: TODO](#ecosystem-lib-monorepo-todo)

-   [ECOSYSTEM: LIB: JAMSTACK](#ecosystem-lib-jamstack)

-   [ECOSYSTEM: LIB: SCULLY](#ecosystem-lib-scully)

-   [ECOSYSTEM: LIB: SSR](#ecosystem-lib-ssr)

-   [ECOSYSTEM: LIB: IMMUTABLE](#ecosystem-lib-immutable)

-   [ECOSYSTEM: LIB: PRETTIER](#ecosystem-lib-prettier)
...
-   [ECOSYSTEM: LIB: SIGNALS](#ecosystem-lib-signals)
...
-   [ECOSYSTEM: LIB: PIPES&DIRECTIVES&DECORATORS](#ecosystem-lib-pipesdirectivesdecorators)

-   [ECOSYSTEM: LIB: MIXED](#ecosystem-lib-mixed)
...
-   [ECOSYSTEM: LIB: SCHEMATICS](#ecosystem-lib-schematics)

-   [ECOSYSTEM: LIB: DESIGN SYSTEM](#ecosystem-lib-design-system)

-   [ECOSYSTEM: LIB: UNIT TESTS](#ecosystem-lib-unit-tests)

-   [ECOSYSTEM: LIB: OPTIMIZATION](#ecosystem-lib-optimization)

-   [ECOSYSTEM: LIB: MARKETING / TRACKING](#ecosystem-lib-marketing--tracking)

-   [ECOSYSTEM: LIB: DEBUG](#ecosystem-lib-debug)

-   [ECOSYSTEM: LIB: INTERNATIONALIZATION / LOCALE / LOKALIZE / I18N](#ecosystem-lib-internationalization--locale--lokalize--i18n)
...
-   [ECOSYSTEM: LIB: COMPONENT: ALERT / TOAST / SNACKBAR / NOTIF](#ecosystem-lib-component-alert--toast--snackbar--notif)

-   [ECOSYSTEM: LIB: COMPONENT: QR CODE](#ecosystem-lib-component-qr-code)

-   [ECOSYSTEM: LIB: COMPONENT: LAYOUT](#ecosystem-lib-component-layout)

-   [ECOSYSTEM: LIB: COMPONENT: DRAG AND DROP](#ecosystem-lib-component-drag-and-drop)

-   [ECOSYSTEM: LIB: COMPONENT: SNACKBAR / TOASTR](#ecosystem-lib-component-snackbar--toastr)

-   [ECOSYSTEM: LIB: COMPONENT: ICONS](#ecosystem-lib-component-icons)

-   [ECOSYSTEM: LIB: COMPONENT: LAYOUT / GRID / TABLE](#ecosystem-lib-component-layout--grid--table)

-   [ECOSYSTEM: LIB: COMPONENT: PRIMITIVES / CDK MATERIAL](#ecosystem-lib-component-primitives--cdk-material)

-   [ECOSYSTEM: LIB: COMPONENT: CAROUSEL/SLIDER/GALLERY](#ecosystem-lib-component-carouselslidergallery)

-   [ECOSYSTEM: LIB: COMPONENT: TOUR](#ecosystem-lib-component-tour)

-   [ECOSYSTEM: LIB: COMPONENT: SCROLL](#ecosystem-lib-component-scroll)

-   [ECOSYSTEM: LIB: COMPONENT: SELECT](#ecosystem-lib-component-select)
...
-   [ECOSYSTEM: LIB: COMPONENT: LOADER / LOADING / PROGRES](#ecosystem-lib-component-loader--loading--progres)

-   [ECOSYSTEM: LIB: COMPONENT: FORMS](#ecosystem-lib-component-forms)

-   [ECOSYSTEM: LIB: COMPONENT: TEXT EDITOR / WYSIWYG](#ecosystem-lib-component-text-editor--wysiwyg)

-   [ECOSYSTEM: LIB: COMPONENT: DRAG](#ecosystem-lib-component-drag)

-   [ECOSYSTEM: LIB: COMPONENT: MEDIA+2D/3D](#ecosystem-lib-component-media2d3d)

-   [ECOSYSTEM: LIB: UI](#ecosystem-lib-ui)

-   [ECOSYSTEM: LIB: STORAGE](#ecosystem-lib-storage)

-   [ECOSYSTEM: LIB: ANIMATIONS](#ecosystem-lib-animations)

-   [ECOSYSTEM: LIB: AUTH](#ecosystem-lib-auth)

-   [ECOSYSTEM: LIB: PAYMENT](#ecosystem-lib-payment)

-   [ECOSYSTEM: LIB: CRYPTO](#ecosystem-lib-crypto)

-   [ECOSYSTEM: LIB: RPC](#ecosystem-lib-rpc)

-   [ECOSYSTEM: LIB: GEOLOCATION](#ecosystem-lib-geolocation)

-   [ECOSYSTEM: LIB: ACL](#ecosystem-lib-acl)

-   [ECOSYSTEM: LIB: ANIMATIONS](#ecosystem-lib-animations-1)

-   [ECOSYSTEM: LIB: PWA / WEBPUSH](#ecosystem-lib-pwa--webpush)

-   [ECOSYSTEM: CI/CD](#ecosystem-cicd)

-   [ECOSYSTEM: PLUG & PLAY:](#ecosystem-plug--play)

-   [ECOSYSTEM: DEMO: EXPERIMENT](#ecosystem-demo-experiment)

-   [ECOSYSTEM: DEMO: TRAINING](#ecosystem-demo-training)
...
-   [ECOSYSTEM: DEMO: SOURCES & EXAMPLES: NX](#ecosystem-demo-sources--examples-nx)

-   [ECOSYSTEM: DEMO: SOURCES & EXAMPLES: SCULLY](#ecosystem-demo-sources--examples-scully)

-   [ECOSYSTEM: DEMO: SOURCES & EXAMPLES: INSTALL](#ecosystem-demo-sources--examples-install)

-   [ECOSYSTEM: DEMO: SOURCES & EXAMPLES: FULL](#ecosystem-demo-sources--examples-full)

-   [ECOSYSTEM: DEMO: SOURCES & EXAMPLES: MICROFRONTENDS](#ecosystem-demo-sources--examples-microfrontends)

-   [ECOSYSTEM: DEMO: SOURCES & EXAMPLES: SPA](#ecosystem-demo-sources--examples-spa)
...
-   [ECOSYSTEM: OTHERS](#ecosystem-others)
