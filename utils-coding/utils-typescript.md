...
-   [LIB: ASSEMBLYSCRIPT / WASM](#lib-assemblyscript--wasm)

-   [LIB: DATABASE / SQL](#lib-database--sql)

-   [LIB: PARSER](#lib-parser)

-   [LIB: ASYNC / STREAM / REACTIVE](#lib-async--stream--reactive)
...
-   [LIB: GENERATE DATA OBJECT](#lib-generate-data-object)
...
-   [LIB: EXECUTION / ORCHESTRATION](#lib-execution--orchestration)
...
-   [CLASSES INHERIT](#classes-inherit)

-   [GENERIC TYPE / SERVICE](#generic-type--service)
...
-   [CHEATSHEETS](#cheatsheets)
    ...
    -   [Object literal map:](#object-literal-map)
    -   [Enum](#enum)
    -   [As const](#as-const)
    -   [Define value from enum](#define-value-from-enum)
    -   [Generic values type from key of type](#generic-values-type-from-key-of-type)
    -   [Object vs primitive type](#object-vs-primitive-type)
    -   [Typescript union vs generic,](#typescript-union-vs-generic)
    -   [EXTENDS](#extends)
